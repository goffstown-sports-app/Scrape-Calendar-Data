...
class UnitTest(unittest.TestCase):
    ...
    def test_get_events_for_day(self):
        ...
        self.assertEqual(single_content_response, [{'isAuthorized': True, 'isCancelled': 0, 'Month': 6, 'theTitle': 'Boys Varsity Volleyball', 'eventid': 75486571, 'isPostponed': 0, 'thedate': '(H) 6:00PM vs Pinkerton Academy',
                                                    'homeOrAway': 1, 'postcancelled': '', 'eventType': 'home', 'Year': 2019, 'thePlace': '@ GHS Gymnasium', 'rescheddate': '', 'Day': 4, 'theEventTitle': 'NHIAA Playoff Quarterfinal'}])

        self.assertEqual(double_content_response, [{'isAuthorized': True, 'isCancelled': 0, 'Month': 6, 'theTitle': 'Boys Varsity Volleyball', 'eventid': 75496026, 'isPostponed': 0, 'thedate': '(A) 5:00PM vs Salem Athletics', 'homeOrAway': 0, 'postcancelled': '', 'eventType': 'away', 'Year': 2019, 'thePlace': '@ Nashua North High School', 'rescheddate': '', 'Day': 6, 'theEventTitle': 'NHIAA Semifinals'}, {
                         'isAuthorized': True, 'isCancelled': 0, 'Month': 6, 'theTitle': 'Boys Varsity Lacrosse', 'eventid': 75507003, 'isPostponed': 0, 'thedate': '(H) 7:15PM vs Derryfield School', 'homeOrAway': 1, 'postcancelled': '', 'eventType': 'home', 'Year': 2019, 'thePlace': '@ Stellos Stadium', 'rescheddate': '', 'Day': 6, 'theEventTitle': 'NHIAA Semifinals'}])
    ...
    def test_cleaning_response(self):
        ...
        self.assertEqual(double_content_response, [{'gender': 'm', 'varsity': True, 'ghs_sport': True, 'home': False, 'location': 'Nashua North High School', 'start-time-(normal)': '5:00PM', 'stat-time-(datetime)': datetime.datetime(2019, 6, 6, 17, 0), 'hour': 17, 'minute': 0, 'away_team_name': 'Salem Athletics', 'sport': 'Volleyball', 'cancelled': False}, {
                         'gender': 'm', 'varsity': True, 'ghs_sport': True, 'home': True, 'location': 'Stellos Stadium', 'start-time-(normal)': '7:15PM', 'stat-time-(datetime)': datetime.datetime(2019, 6, 6, 19, 15), 'hour': 19, 'minute': 15, 'away_team_name': 'Derryfield School', 'sport': 'Lacrosse', 'cancelled': False}])
