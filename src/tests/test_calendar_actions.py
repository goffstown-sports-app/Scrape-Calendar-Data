...
def test_cleaning_response():
    ...
    assert single_content_response == [{'gender': 'm', 'varsity': True, 'ghs_sport': True, 'home': True, 'location': 'GHS-GYM-FIELD', 'start-time-(normal)': '6:00PM', 'stat-time-(datetime)': datetime.datetime(2019, 6, 4, 18, 0), 'hour': 18, 'minute': 0, 'away_team_name': 'Pinkerton Academy', 'sport': 'Volleyball', 'cancelled': False}]
